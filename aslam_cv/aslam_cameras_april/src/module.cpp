...
BOOST_PYTHON_MODULE(libaslam_cameras_april_python)
{
  ...
  class_<GridCalibrationTargetAprilgrid::AprilgridOptions>("AprilgridOptions", init<>())
    ...
    .def_readwrite("saveExtractionImages", &GridCalibrationTargetAprilgrid::AprilgridOptions::saveExtractionImages)
    .def_readwrite("extractionImagesOutputPath", &GridCalibrationTargetAprilgrid::AprilgridOptions::extractionImagesOutputPath)
